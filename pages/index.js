...
function index(props) {
	...
	return (
		<>
			<Header>
				<title>
					Compilado; - Programação, Open Source e muito código
				</title>
				<meta
					name='description'
					content='A missão do Blog Compilado é lhe passar conhecimentos importantes sobre o mundo da programação com artigos completos e explicativos.'
				/>
				<meta
					name='keywords'
					content='programação,tecnologia,open source,tutorial,code,javascript,nodejs,node,npm,security,compilado,blog,machine learning,aprendizado de máquina,inteligêngia artificial,ia,ai,ml,discord,bot,discord.js'
				/>
				...
				<meta
					property='og:title'
					content='Compilado; - Programação, Open Source e muito código'
				/>
				<meta
				...
				<meta
					property='og:image'
					content='https://res.cloudinary.com/williamspacefire/image/upload/v1611871360/compilado/discord_bot_lnnyyy.jpg'
				/>
				<meta
				...
				<meta
					...
					content='inteligêngia artificial'
				/>
...
export async function getStaticProps() {
	...
	const [rows] = await connection.query(
		"SELECT * FROM posts WHERE status = 'publish' ORDER BY id DESC LIMIT 5"
	)
