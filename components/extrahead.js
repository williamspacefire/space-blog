function ExtraHead() {
	return (
		<>
			<meta
				name='keywords'
				content='tutorial,discord,bot,meycup,discord.js,automatização,javascript,nodejs,shell,npm'
			/>
			...
			<meta
				property='og:title'
				content='Criando um Bot para o Discord com Node.js – Parte 1 – MeyCup'
			/>
			<meta
				property='og:description'
				content='Nessa série de posts vamos aprender a criar um bot para o Discord. Recentemente eu precisei de um Bot para um servidor do Discord que eu tenho, existem várias opções de Bots atualmente, opções muito boas até, mas eu estava precisando de algo personalizado, uma personalização que os outros Bots não oferecem.'
			/>
			<meta
				property='og:url'
				content='https://compilado.xyz/criando-um-bot-para-o-discord-com-node-js-parte-1/'
			/>
			<meta
				property='og:image'
				content='https://i0.wp.com/blog.meycup.com/wp-content/uploads/2020/09/12.jpg?fit=910%2C480&#038;ssl=1'
			/>
			<meta
			...
			<meta
				...
				content='2020-11-01T03:00:00Z'
			/>
			<meta
				property='article:modified_time'
				content='2020-11-01T12:54:24Z'
			/>
			...
			<meta
				...
				content='https://i0.wp.com/blog.meycup.com/wp-content/uploads/2020/09/screen08.jpg?fit=1024%2C465&amp;ssl=1'
			/>
		</>
	)
}
